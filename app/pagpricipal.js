...
peliculas = [
        ...
        new Peliculas("Spiderman",184,"Peter Parker ha sido Spiderman durante casi dos años. En este tiempo se ha enfrentado a retos personales realmente heroicos mientras mantenía a salvo la ciudad de Nueva York.","true", "true","../assets/ACCION/spidercard.jpg","infantil","../assets/PORTADAS/foto-spiderman.jpeg"),
        ...
        new Peliculas ("Raya y El Último Dragón",120,"En un reino conocido como Kumandra, una Tierra reimaginada habitada por una civilización antigua, un guerrero llamado Raya está decidido a encontrar al último dragón","true","true","../assets/INFANTILES/INFANTILES-RAYA.jpg","infantil","../assets/PORTADAS/RAYADRAGON.jpg"),
        new Peliculas ("Mal de Ojo", 135, "La misteriosa enfermedad de su hermana pequeña hará que Nala y su familia viajen a la casa de su abuela para encontrar la cura. En este lugar, ella aprenderá sobre leyendas locales de brujas que se alimentan de la sangre de los niños para permanecer por siempre jóvenes. Mientras más conoce Nala sobre estos seres diabólicos, más se convencerá de que su abuela podría ser una bruja", "true", "true", "../assets/TERROR/TERROR-MALDEOJO.jpg","terror","../assets/PORTADAS/MalDeOjoChica.png"),
        ...
        new Peliculas ("Navidad de golpe", 160,"Tras perder la memoria esquiando, una heredera mimada termina al cuidado de un viudo desafortunado y su hija en los días previos a la Navidad. Película exclusiva de Netflix","true","true","../assets/COMEDIA/NAVIDADDEGOLPE.jpg","comedia","../assets/PORTADAS/NAVIDADDEGOL.jpg"),
        new Peliculas("Bros: más que amigos",170,"Dos hombres con problemas de compromiso intentan una relación","true","true","../assets/COMEDIA/BROS.jpg","comedia","../assets/PORTADAS/bros.png"),
